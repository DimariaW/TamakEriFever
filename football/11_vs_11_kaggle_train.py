...
def build_scenario(builder):
  builder.config().game_duration = random.randint(1000, 2500)
  builder.config().second_half = builder.config().game_duration // 2
  builder.config().right_team_difficulty = 0.1
  builder.config().left_team_difficulty = 0.1
