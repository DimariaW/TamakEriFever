...
from .model import FootballNet as Model
...
class Trainer:
    ...
    def run(self):
        ...
        while not self.shutdown_flag:
            ...
            print("start training a step")
            model = self.train()
            print("end training a step")
...
class Learner:
    def __init__(self, args, device):
        ...
        train_model = TrainerModel(self.model_class())
    ...
    def feed_episodes(self, episodes):
        ...
        for episode in episodes:
            ...
            sw.add_scalar("outcome", episode["outcome"][0], self.global_episodes)
        ...
        #if len(self.trainer.episodes) >= 4:
         #   episodes = [self.trainer.batcher.select_episode() for _ in range(4)]
           # episodes = make_batch(episodes, self.args)
    ...
    def feed_results(self, results):
        ...
        for model_id, result in results:
            ...
            opp, reward = result
            self.global_eval += 1
            sw.add_scalar("eval_win_rate", (reward + 1) / 2, global_step=self.global_eval)
                ...
                if req == 'args':
                    for _ in data:
                        ...
                        if args['role'] == 'g':
                            ...
                            self.num_episodes += 1
                            print(f"total num episodes: is {self.num_episodes}")
